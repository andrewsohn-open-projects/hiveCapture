...
$config['title'] = 'DEV::Your Singapore Ultimate Adventure';
$config['version'] = '0.0.1';
$config['asset_mode'] = '';
$config['asset_url'] = 'http://' . $config['base_domain'] . '/singaporeAL/assets/front';
$config['upload_url'] = 'http://' . $config['base_domain'] . '/singaporeAL/uploads';
$config['data_url'] = $config['asset_url'] . '/data';

$config['sns'] = array(
	'afterLoginUrl' => 'member/afterSocialLoin/',
	'fb' => array(
		'version' => 'v2.4',
		'app_id' => '1465650673749266',
		'app_secret' => '3c1bcf04ba0cba36463770b19fc5a1bc',
		'app_scope' => 'email,user_birthday'
	)
);
...
$config['sgal'] = array(
	...
	'google' => array(
		...
		'key' => 'AIzaSyA9ek337Dut-OFMjWAVANwi8LUzJtVLDD0'
		, 'LatLng' => array(
...
$config['sess_cookie_name'] = 'sc_dev_sessc';
...
$config['csrf_token_name'] = 'csrf_token_dev_kasan';
$config['csrf_cookie_name'] = 'csrf_cookie_dev_kasan';
